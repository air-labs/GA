        ...
        protected IEnumerable<ParsedInfo> Parse(IEnumerable<string> data)
        {
            ...
            foreach (var str in data)
            {
                ...
                if (sectionMatch.Success)
                {
                    ...
                    {
                        /*
                         * Эта функциональность, возможно, и хороша, но была недокументирована и мешает парсингу словарей. Пока убрал. Я бы вообще предпочел формат
                         * [SAection1][Section2] а не [Section1,Section2] чтобы не вводить лишних спецсимволов в формат
                        
                         */
                         currentAddress.Add(FieldAddress.NewRoot().Child(GetAddress(addr)));
                    }
